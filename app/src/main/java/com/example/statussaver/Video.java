    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mychatapp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Video.this, "Chat is Clicked", Toast.LENGTH_SHORT).show();
            }
        });
...
//        Glide.with(getApplicationContext()).load(uri).into(mparticularimage);
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(Video.this, "Saved! In Galary", Toast.LENGTH_SHORT).show();
                        finish();
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myIntent.putExtra(Intent.ACTION_MEDIA_SHARED,body);
